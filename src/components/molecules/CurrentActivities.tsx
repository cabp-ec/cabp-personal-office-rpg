      ...
      <div className="info-group">
        ...
        <div className="entry-list">
          <div className="mb-2">
            ...
            <p className="fs-12 mb-1">On average, recruiters spend only <strong>6 seconds</strong> scanning a static resume, leading to rapid, unconscious bias based on formatting, name, or educational pedigree.</p>
            <p className="fs-12 mb-1">By transforming the review process into an interactive gameplay mechanic, we <strong>increase the reader's cognitive engagement</strong>.</p>
            <p className="fs-12 mb-2">Because the data is delivered through structured game loops, recruiters focus on core competencies and verified skills rather than surface-level heuristics.</p>
